---
name: ux-review
description: Review the current diff for UX regressions before merge, including state gaps, hierarchy, affordance, copy, accessibility, responsiveness, and design-system drift.
disable-model-invocation: true
---

# UX Review

Read `.uiux/agents/ux-auditor.md`, then delegate to an isolated Cursor subagent using that contract in diff-review mode.
